...
<div class="container">
	...
	<form ng-submit="onSubmit($event)" ng-controller="formCtrl" action="signup.do" method="post" 
			name="f" novalidate>
			<!-- name 속성 꼭 부여!!! -->
				<!-- 클래스 안의 내용이 true면 작동 false면 작동하지 않는 식으로 작동함. 
				예를 들어 myForm.id.$valid가 true면 has-success 클래스가 추가된다.
				has-success, has-error 클래스는 인풋 요소의 색상을 결정 -->
